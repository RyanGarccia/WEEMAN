...
def print_startup():
    ...
    print("\033[00m")
    print(" ")
    slowprint("}~~~~~~~~~~~~~{ Mod by: RyanGarccia }~~~~~~~~~~~~~{")
    slowprint("}~~~{  Github: https://github.com/RyanGarccia }~~~{")
    print (" ")
...
def shell_noint(profile_file):
    ...
    try:
        ...
        printt(3, "Erro: seu arquivo de perfil parece ruim.")
        ...
        if prompt[0] == "help" or prompt[0] == "?":
            ...
            printt(3, "Erro: Forneca opcao para \'%s\'." %prompt[0])
    except Exception as e:
        printt(3, "Erro: (%s)" %(str(e)))
    ...
    while True:
        try:
              ...
              continue
                ...
                if prompt[1] == "port":
                    ...
                    if port == 80 and os.getuid() != 0:
                        printt(2, "Permissao negada, para ligar a porta 80, Voce precisa executar Weeman como ROOT.");
                ...
                if not url:
                    printt(3, "Erro: configure: \"url\".")
                elif not action_url:
                    printt(3, "Erro: configure: \"action_url\".")
                else:
                ...
                print("Erro: Nenhum comando com este nome: \'%s\'." %prompt[0])
            ...
            if prompt[0] == "help" or prompt[0] == "?":
                ...
                printt(3, "Erro: Forneca opcao para:  \'%s\'." 
%prompt[0])
        except Exception as e:
            printt(3, "Erro: (%s)" %(str(e)))
